...
const Succes: React.FC<ToastProps> = ({ message }) => {
  ...
  return (
    <div
      className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-800 text-white p-4 rounded shadow-lg transition-opacity cursor-pointer ${
