...
const BuyCoinmodal: React.FC<DepositProps> = ({ SetBuycoinsmodal }:any) => {
const player = {
  id: 8732157843,
};
    ...
    <>
      <div className="z-[400]">
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div>
            <div
              className={`w-[95%]  text-white sm:w-[80%] md:w-[70%] lg:w-[60%] absolute left-1/2 
          top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-Background rounded-b-md z-[100]`}
            >
              <div>
                <button
                ...
                >
                  ...
                  <Image
                    ...
                    onClick={() => SetBuycoinsmodal(false)}
                    alt="x"
                    width={50}
                    height={50}
                ...
                <div className="banned-player-list bg-Background py-3 sm:py-4 md:py-5 lg:py-6">
                  <div className="flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 px-6">
                    <p className="text-center text-xs sm:text-sm md:text-base lg:text-lg w-[90%] sm:w-[80%] md:w-[75%] lg:w-[72%] mx-auto">
                      You will be redirected to our Telegram chat to request to
                      add to / withdraw from game wallet balance. Please copy
                      the text below and paste it in the chat box:
                    </p>
