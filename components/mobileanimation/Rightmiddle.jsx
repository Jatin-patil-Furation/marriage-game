...
const Rightmiddle = ({ cardsInfo }) => {
  ...
  return (
    <>
      {!cardsInfo ? (
        <div className="">
          <div className="relative top-[-2rem] right-[99%]  w-[55%] m-auto items-center">
            <Image
      ...
      <div className="containerrightmiddletop left-20 top-[-2.5rem] ">
        {cardsInfo?.length > 0 &&
          cardsInfo?.map((el, index) => {
            return (
              <div
                key={el.id}
                className={`cardrightmiddletop   xs:h-[2.2rem] xs:w-[1.6rem] ${
